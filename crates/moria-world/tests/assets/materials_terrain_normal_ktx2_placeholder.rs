...
#[test]
fn terrain_normal_placeholder_uses_the_declared_loader_route_and_linear_basis_ktx2_layout() {
    let loader = AssetLoader::new();
    let declaration = loader
        .resolve_runtime_path(TERRAIN_NORMAL_PATH)
        .expect("the predeclared terrain-normal runtime path resolves");
