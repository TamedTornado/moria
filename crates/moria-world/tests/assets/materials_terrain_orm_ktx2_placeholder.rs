...
#[test]
fn terrain_orm_placeholder_is_a_linear_mipmapped_basis_ktx2_array_matching_albedo_layout() {
    ...
    assert_eq!(
        ...
        TERRAIN_LAYER_COUNT,
        "ORM layers retain the material-ID ordering of terrain albedo"
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        "ORM layers use linear sampling"
    );
}
