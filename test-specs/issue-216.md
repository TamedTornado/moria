# Issue 216 — Wire acquired assets/vegetation/bush_near.glb
...
- Install exactly `assets/vegetation/bush_near.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF support-centered within configured bush ellipsoid bounds, finite required attributes/shared materials and <=2000 triangles.
...
- Independently mutate the fixture for: support/bounds mismatch, unique material, malformed attributes or 2001 triangles. Each mutation must fail the precise schema/format/budget rule.
