# Issue 213 — Wire acquired assets/vegetation/pine_near.glb
...
- Install exactly `assets/vegetation/pine_near.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF 2.0 metres/Y-up/+Z-forward, support-center origin, pine analytic bounds/shared materials and <=12000 triangles.
...
- Independently mutate the fixture for: wrong axes/units/origin/bounds, malformed attributes, unique material or 12001 triangles. Each mutation must fail the precise schema/format/budget rule.
