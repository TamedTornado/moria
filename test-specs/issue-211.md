# Issue 211 — Wire acquired assets/vegetation/birch_mid.glb
...
- Install exactly `assets/vegetation/birch_mid.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF matching birch origin/bounds conventions, shared material keys and <=3000 triangles.
...
- Independently mutate the fixture for: origin/bounds/LOD mismatch, unique material, malformed attributes or 3001 triangles. Each mutation must fail the precise schema/format/budget rule.
