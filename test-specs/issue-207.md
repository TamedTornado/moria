# Issue 207 — Wire acquired assets/materials/terrain_normal.ktx2
...
- Install exactly `assets/materials/terrain_normal.ktx2` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates Basis Universal KTX2 linear 14-layer normal array with dimensions/order/mips exactly matching terrain_albedo.
...
- Independently mutate the fixture for: wrong color space/payload/layers/mips/order or mismatch with installed albedo. Each mutation must fail the precise schema/format/budget rule.
