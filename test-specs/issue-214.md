# Issue 214 — Wire acquired assets/vegetation/pine_mid.glb
...
- Install exactly `assets/vegetation/pine_mid.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF matching pine origin/bounds conventions, shared material keys and <=3000 triangles.
