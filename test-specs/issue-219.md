# Issue 219 — Wire acquired assets/vegetation/tree_horizon_cards.ktx2
...
- Install exactly `assets/vegetation/tree_horizon_cards.ktx2` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates mipmapped cross-platform Basis Universal KTX2 atlas containing matching birch/pine color, normal and opacity silhouettes and registry color-space/layout facts.
...
- Independently mutate the fixture for: missing species/channel/silhouette, mismatched atlas layout, missing mips, non-Basis/backend-incompatible payload. Each mutation must fail the precise schema/format/budget rule.
