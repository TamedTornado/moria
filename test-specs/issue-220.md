# Issue 220 — Wire acquired assets/props/boulder.glb
...
- Install exactly `assets/props/boulder.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF support-centered within configured boulder bounds, all required named variants, shared materials and <=3000 triangles per variant.
