# Issue 222 — Wire acquired assets/props/rock.glb
...
- Install exactly `assets/props/rock.glb` at that unchanged runtime path; the issue writes no sibling content or either production registry.
- The loader validates binary glTF support-centered within configured rock bounds, all required named variants, shared materials and <=3000 triangles per variant.
