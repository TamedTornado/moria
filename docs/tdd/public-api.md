...
and ordinary per-volume placement/revision preparation capacity. Egress
registration requires an exact
...
results, placement stream, directory-generation extraction gate, opaque egress receipt ordering,
