...
- extraction, directory entries, presentation
...
world-box continuity, and one multi-volume directory-generation visibility gate. Copy
...
after the one multi-volume directory-generation publication. Old-generation
...
directory/live/lifetime pool exhaustion,
...
records are unique and the expected directory generation/revision vector is exact.
...
- P12 failure rejects atomic GPU component extraction or its multi-volume directory
